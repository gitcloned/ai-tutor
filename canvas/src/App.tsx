...
const modelShapeUtils=[ModelShapeUtil,QuestionFrameUtil.configure({getCustomDisplayValues:(_editor,shape)=>shape.meta.kind==='question'?{fillColor:'transparent',strokeColor:'transparent',headingFillColor:'transparent',headingStrokeColor:'transparent',headingTextColor:'transparent',showColorsFillColor:'transparent',showColorsStrokeColor:'transparent',showColorsHeadingFillColor:'transparent',showColorsHeadingStrokeColor:'transparent',showColorsHeadingTextColor:'transparent'}:{}})];
...
export default function App() {
  ...
  async function sendWork(audio?:MediaInput){
    ...
    if(sending.current||lesson.submission!=='idle'||!work.current||!editor)return;
  ...
  return <main className="app">
    ...
    <Orb phase={lesson.phase} submission={lesson.submission} preparing={preparing} watching={!!lesson.video} onTap={tapOrb} onAudio={audio=>{void sendWork(audio);}} onRecording={lesson.recording} notify={lesson.notify}/>
